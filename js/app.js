    ...
    if (animItems.length > 0) {
        ...
        function animOnScroll() {
            for (let index = 0; index < animItems.length; index++) {
                ...
                if (pageYOffset > animItemOffset - animItemPoint && pageYOffset < animItemOffset + animItemHeight) animItem.classList.add("_active"); else if (!animItem.classList.contains("_anim-no")) animItem.classList.remove("_active");
            }
        }
        function offset(el) {
